...
# return: A palavra-chave "return" é usada para finalizar a execução de uma função e retornar o valor para o local onde a função foi chamada. O valor retornado pode ser usado posteriormente no código.
...
# def caucula_dobro(numero):
#     numero_usuario = float(input("Qual número você deseja caucular o dobro?"))
#     return numero_usuario * 2
#   print(caucular_dobro())
